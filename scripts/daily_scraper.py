while urls_queue or retry_queue:
    # فرض بر این است که اینجا متغیرهای slug و لینک‌ها را مدیریت می‌کنی و page لود می‌شود
    
    try:
        # حرف r قبل از کوتیشن‌ها اضافه شد تا مشکل \s در جاوااسکریپت حل شود
        ...
        # فرض می‌کنیم extractor.find_nation ایمپورت شده است
        ...
        if img_url and img_url.startswith('/'): 
            img_url = f"https://wiki.warthunder.com{img_url}"
        ...
        # مدیریت خطاهای احتمالی در لود صفحه یا اجرای جاوااسکریپت
        print(f"❌ Error processing page for {slug}: {str(e)}")
