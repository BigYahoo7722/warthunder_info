# در داخل حلقه while urls_queue or retry_queue و درون بلاک try:
            ...
            # حرف r قبل از کوتیشن‌ها اضافه شد تا مشکل \s حل شود
            page_data = page.evaluate(r"""() => {
                ...
                infoRows.forEach(row => {
                    ...
                    if (th && td) {
                        // اینجا \s باعث ارور میشد که با گذاشتن r در پایتون حل شد
            ...
            # فرض می‌کنیم extractor.find_nation رو قبل از این بلاک یا در بالای فایل ایمپورت کردی
