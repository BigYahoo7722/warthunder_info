 ...
 * best-effort (see the "Trigger Next.js cache revalidation" step in each
 * of .github/workflows/scraper-{aviation,fleet,ground,helicopter}.yml —
 * one workflow per category, not a single combined daily-scraper.yml).
 *
