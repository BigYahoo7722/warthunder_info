...
export function Sidebar({
  ...
  return (
    ...
    >
      <ul className="flex w-16 flex-col border-e border-hairline/70 bg-panel/50 py-3 backdrop-blur-md sm:w-[72px]">
        {NATIONS.map((nation) => {
      ...
      <AnimatePresence>
        {openNation && (
          <motion.div
            ...
            className="absolute start-16 z-10 w-64 overflow-y-auto border-e border-hairline/70 bg-panel/70 shadow-dossier backdrop-blur-xl sm:start-[72px]"
          >
